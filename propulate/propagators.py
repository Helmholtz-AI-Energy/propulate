...
class Stochastic(Propagator):
    ...
    def __init__(self, parents=0, offspring=0, probability=1.0):
        """
...
class PointMutation(Stochastic):
    ...
    def __init__(self, limits, points=1, probability=1.0):
        """
...
class RandomPointMutation(Stochastic):
    ...
    def __init__(self, limits, min_points, max_points, probability=1.0):
        """
...
class IntervalMutationNormal(Stochastic):
    ...
    def __init__(self, limits, sigma_factor=0.1, points=1, probability=1.0):
        """
...
class MateUniform(Stochastic):  # uniform crossover
    ...
    def __init__(self, rel_parent_contrib=0.5, probability=1.0):
        """
...
class MateMultiple(Stochastic):  # uniform crossover
    ...
    def __init__(self, parents=-1, probability=1.0):
        """
...
class MateSigmoid(
    ...
    def __init__(self, temperature=1.0, probability=1.0):
        """
...
class InitUniform(Stochastic):
    ...
    def __init__(self, limits, parents=0, probability=1.0):
        """
