...
for func in "${FUNCTIONS[@]}"; do
  for ((run=1; run<=10; run++)); do
    ...
    sbatch "$DIRECTORY/default_prop/migr/default_prop_migr_${func}.sh" > "$DIRECTORY/default_prop/migr/default_prop_migr_${func}_run${run}.out"
    sbatch "$DIRECTORY/default_prop/polli/default_prop_polli_${func}.sh" > "$DIRECTORY/default_prop/polli/default_prop_polli_${func}_run${run}.out"
    sbatch "$DIRECTORY/cma/basic/cma_basic_${func}.sh" > "$DIRECTORY/cma/basic/cma_basic_${func}_run${run}.out"
    sbatch "$DIRECTORY/cma/active/cma_active_${func}.sh" > "$DIRECTORY/cma/active/cma_active_${func}_run${run}.out"
    sbatch "$DIRECTORY/cma_island/basic/migr/cma_basic_migr_${func}.sh" > "$DIRECTORY/cma_island/basic/migr/cma_basic_migr_${func}_run${run}.out"
    ...
    sbatch "$DIRECTORY/cma_island/active/migr/cma_active_migr_${func}.sh" > "$DIRECTORY/cma_island/active/migr/cma_active_migr_${func}_run${run}.out"
    ...
    sbatch "$DIRECTORY/multi_dim/default_prop/polli/multi_10_default_prop_polli_${func}.sh" > "$DIRECTORY/multi_dim/default_prop/polli/multi_10_default_prop_polli_${func}_run${run}.out"
    sbatch "$DIRECTORY/multi_dim/default_prop/polli/multi_100_default_prop_polli_${func}.sh" > "$DIRECTORY/multi_dim/default_prop/polli/multi_100_default_prop_polli_${func}_run${run}.out"
    sbatch "$DIRECTORY/multi_dim/cma/active/multi10_cma_active_${func}.sh" > "$DIRECTORY/multi_dim/cma/active/multi10_cma_active_${func}_run${run}.out"
    sbatch "$DIRECTORY/multi_dim/cma/active/multi100_cma_active_${func}.sh" > "$DIRECTORY/multi_dim/cma/active/multi100_cma_active_${func}_run${run}.out"
    sbatch "$DIRECTORY/multi_dim/cma_island/active/migr/multi10_cma_active_migr_${func}.sh" > "$DIRECTORY/multi_dim/cma_island/active/migr/multi10_cma_active_migr_${func}_run${run}.out"
    sbatch "$DIRECTORY/multi_dim/cma_island/active/migr/multi100_cma_active_migr_${func}.sh" > "$DIRECTORY/multi_dim/cma_island/active/migr/multi100_cma_active_migr_${func}_run${run}.out"
  done
done
